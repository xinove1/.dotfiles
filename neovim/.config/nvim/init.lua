...
vim.api.nvim_create_autocmd('CmdlineLeave', { command = 'silent !setxkbmap br', group = group })
vim.api.nvim_create_autocmd('CmdlineEnter', { command = 'silent !setxkbmap us -variant dvorak', group = group })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>j'] = { name = 'Utils', _ = 'which_key_ignore' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>tp', builtin.registers, { desc = 'Registers' })
      ...
      vim.keymap.set('n', '<leader>hs', builtin.builtin, { desc = 'Search Select Telescope' })
      vim.keymap.set('n', '<leader>hw', builtin.grep_string, { desc = 'Search current Word' })
      vim.keymap.set('n', '<leader>hg', builtin.live_grep, { desc = 'Search by Grep' })
      vim.keymap.set('n', '<leader>hd', builtin.diagnostics, { desc = 'Search Diagnostics' })
      ...
      end, { desc = 'Fuzzily search current word in current buffer' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'gdscript', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc' },
  ...
  { -- The task runner we use
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>cc', '<CMD>OverseerRun<CR>', { desc = 'Open projects' })
    end,
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>jp', '<CMD>Telescope projects<CR>', { desc = 'Open projects' })
    end,
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>dz', dapui.toggle, { desc = 'Debug: See last session result.' })
