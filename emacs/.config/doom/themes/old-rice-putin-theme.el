...
;;; Commentary:
;;
;; Cloned doom-one file with colors from: https://git.pyratebeard.net/dotfiles/file/urxvt-colors/oldriceputin.html
;;
;;; Code:
...
(def-doom-theme old-rice-putin
  "A dark theme inspired by Atom One Dark."

  ;; name        default   256           16
  ((bg         '("#1f1d1b" "black"       "black"  ))
   (fg         '("#fbf0d2" "#bfbfbf"     "brightwhite"  ))

   ;; These are off-color variants of bg/fg, used primarily for `solaire-mode',
   ;; but can also be useful as a basis for subtle highlights (e.g. for hl-line
   ;; or region), especially when paired with the `doom-darken', `doom-lighten',
   ;; and `doom-blend' helper functions.
   (bg-alt     '("#1f1d1b" "black"       "black"        ))
   (fg-alt     '("#fbf0d2" "#2d2d2d"     "white"        ))

   ;; These should represent a spectrum from bg to fg, where base0 is a starker
   ;; bg and base8 is a starker fg. For example, if bg is light grey and fg is
   ;; dark grey, base0 should be white and base8 should be black.
   (base0      '("#181512" "black"       "black"        ))
   (base1      '("#1c1f24" "#1e1e1e"     "brightblack"  ))
   (base2      '("#202328" "#2e2e2e"     "brightblack"  ))
   (base3      '("#23272e" "#262626"     "brightblack"  ))
   (base4      '("#454545" "#3f3f3f"     "brightblack"  ))
   (base5      '("#5B6268" "#525252"     "brightblack"  ))
   (base6      '("#73797e" "#6b6b6b"     "brightblack"  ))
   (base7      '("#9ca0a4" "#979797"     "brightblack"  ))
   (base8      '("#d3cab3" "#dfdfdf"     "white"        ))

   (grey       base4)
   (red        '("#bb6055" "#ff6655" "red"          ))
   (orange     '("#c94539" "#dd8844" "brightred"    ))
   (green      '("#80964d" "#99bb66" "green"        ))
   (teal       '("#aabb46" "#44b9b1" "brightgreen"  ))
   (yellow     '("#8b6268" "#ECBE7B" "yellow"       ))
   (blue       '("#756583" "#51afef" "brightblue"   ))
   (dark-blue  '("#a3535e" "#2257A0" "blue"         ))
   (magenta    '("#628185" "#c678dd" "brightmagenta"))
   (violet     '("#becc90" "#a9a1e1" "magenta"      ))
   (cyan       '("#a4b810" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#69c884" "#5699AF" "cyan"         ))
