...
;;  '(org-agenda-files '("~/stuff/Notas/roam/20210913110509-home.org")))
;; (custom-set-faces
...
;;  '(org-level-1 ((t (:inherit default :weight bold :foreground "#FFFFFF" :font "ETBembo" :height 1.15))))
;;  '(org-level-2 ((t (:inherit default :weight bold :foreground "#FFFFFF" :font "ETBembo" :height 1.05))))
;;  '(org-level-3 ((t (:inherit default :weight bold :foreground "#FFFFFF" :font "ETBembo" :height 1.0))))
;;  '(org-level-4 ((t (:inherit default :weight bold :foreground "#FFFFFF" :font "ETBembo" :height 1.0))))
